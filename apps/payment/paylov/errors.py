...
error_codes = {
    "OTP_CODE_ALREADY_SENT": ("otp_code_already_sent", _("The OTP code has already been sent.")),
    ...
    "INSUFFICIENT_FUNDS": ("insufficient_funds", _("There are insufficient funds available.")),
    ...
    "GATEWAY_NOT_WORKING": ("gateway_not_working", _("The payment gateway is not working.")),
    "TRANSACTION_ALREADY_PAYED": ("transaction_already_payed", _("The transaction has already been paid.")),
    ...
    "TERMINAL_DOES_NOT_EXIST": ("terminal_does_not_exist", _("The terminal does not exist.")),
    "CARD_IS_ALREADY_ACTIVATED": ("card_is_already_activated", _("The card is already activated.")),
    "FIELD_NOT_VALID": ("field_not_valid", _("The field is not valid.")),
    "BANK_NOT_FOUND": ("bank_not_found", _("The bank could not be found.")),
    "MERCHANT_NOT_AVAILABLE": ("merchant_not_available", _("The merchant is not available.")),
    "INVALID_AMOUNT": ("invalid_amount", _("The amount is invalid.")),
    "TRANSACTION_NOT_AVAILABLE_FOR_PAYMENT": ("transaction_not_available_for_payment", _("The transaction is not available for payment.")),
    "ALREADY_CONFIRMED": ("already_confirmed", _("The transaction has already been confirmed.")),
    ...
    "PAN_NOT_VALID": ("pan_not_valid", _("The PAN (Primary Account Number) is not valid.")),
    "ERROR_CARD_CREATE": ("error_create_card", _("There was an error creating the card.")),
    "CARD_IS_NOT_FOR_THIS_CHECK": ("card_is_not_for_this_check", _("The card is not for this check.")),
